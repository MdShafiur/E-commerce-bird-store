    ...
    if (empty($_POST['d_name']) || empty($_POST['about']) || $_POST['price'] == '' || $_POST['res_name'] == '') {
        ...
        if ($extension == 'jpg' || $extension == 'png' || $extension == 'gif') {        
            if ($fsize >= 1000000) {
                ...
                $sql = "UPDATE products SET rs_id='$_POST[res_name]', title='$_POST[d_name]', slogan='$_POST[about]', price='$_POST[price]', img='$fnew' WHERE d_id='$_GET[product_upd]'";
                $result = mysqli_query($db, $sql);
                if (!$result) {
                    $error = '<div class="alert alert-danger alert-dismissible fade show">
                                  <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                  <strong>SQL Error: ' . mysqli_error($db) . '</strong>
                              </div>';
                } else {
...
<head>
    ...
    <title>Update Product</title><link rel="shortcut icon" href="../images/webicon.png" type="image/png">
                        ...
                        <div class="card card-outline-primary">
                            ...
                            <div class="card-body">
                                <form action='' method='post'  enctype="multipart/form-data">
                                    <div class="form-body">
                                        <?php $qml ="select * from products where d_id='$_GET[product_upd]'";
